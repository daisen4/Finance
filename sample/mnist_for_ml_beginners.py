...
print ("--- finish readin MNIST data ---")
...
print ("precision:{}" .format(sess.run(accuracy, feed_dict={x: mnist.test.images, y_:mnist.test.labels})))

# 終了時刻
end_time = time.time()
print ("finish time:{} " .format(str(end_time)))
print ("processing time:{} " .format(str(end_time - start_time)))
